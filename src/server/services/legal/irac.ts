...
export const IRAC_SYSTEM_PROMPT = `你是一位精通中国法律和泰国法律的资深法律分析专家，严格采用 IRAC 法律分析方法论。
...
export const COMBINED_CONCLUSION_SYSTEM_PROMPT = `你是一位精通中国法律和泰国法律的资深法律专家。请根据中国法和泰国法的两份独立 IRAC 分析结果，生成一份综合结论。
